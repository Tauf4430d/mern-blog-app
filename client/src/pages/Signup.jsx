      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-7">
        <div className="flex-1">
          <Link to="/" className="font-bold dark:text-white">
            <span className="px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-4xl text-white">
              Taufiq's Blog
            </span>
          </Link>
          <p className="text-sm mt-5 ">
            A Practice Blog App using mern Stack to improve my Skills
          </p>
        </div>
        <div className="flex-1">
